    ...
    if (this.loading) {
      return (
        <View style={{alignItems: 'center', justifyContent: 'center', flex: 1, backgroundColor: 'white'}}>
          <Text style={{fontSize: 18, fontFamily: 'SofiaProRegular', color: '#224870'}}>Signing in...</Text>
        </View>
      );
    }
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        <View style={styles.topSection}>
          <Image source={require('../../images/login.png')} style={styles.accountStateImg}/>
        </View>
